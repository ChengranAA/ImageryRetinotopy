...
IMAGE_DPI = 100
OUTPUT_DIRECTORY = "stimuli/sectors_a_pilot"
...
def main():
    ...
    for sector_index in range(NUMBER_OF_SECTORS):
        filename = f"sector_a_{sector_index:02d}.png"
        ...
        sector_masks[f"sector_a_{sector_index:02d}"] = alpha_mask
        print(f"Saved {filename}")

    mask_archive_path = os.path.join(OUTPUT_DIRECTORY, "all_sectors_a.pkl")

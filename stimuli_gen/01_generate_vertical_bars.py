"""Generate alpha masks for sliding vertical bars."""
...
IMAGE_DPI = 100
OUTPUT_DIRECTORY = "stimuli/vertical_bars"
...
def main():
    ...
    for mask_index in range(number_of_masks):
        ...
        filename = f"vertical_bar_{mask_index:02d}.png"
        ...
        bar_masks[f"vertical_bar_{mask_index:02d}"] = alpha_mask
        print(f"Saved {filename}")
    mask_archive_path = os.path.join(OUTPUT_DIRECTORY, "all_vertical_bars.pkl")
